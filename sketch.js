//obs ainda n gosto de fruit ninja só usei ele pq era o projeto mais novo e mais facil de usar
...
var som_da_pexeira,passou_a_lambida_no_monstro;
...
function preload(){
  ...
  som_da_pexeira = loadSound("oque_diabos_e_swoosh.mp3");
  passou_a_lambida_no_monstro = loadSound("oque_carambas_isso_significa.mp3");
}
  ...
  if(estadoJogo===JOGAR){
    ...
    else
    {
      ...
      if(grupoMonstro.isTouching(faca)){
        estadoJogo=ENCERRAR;
        passou_a_lambida_no_monstro.play();
